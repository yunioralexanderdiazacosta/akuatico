...
@push('css-lib')
    ...
    <style>
        ...
        .announcement-type-option:hover {
            border-color: var(--primary);
            background: #f0f7ff;
        }

        .announcement-type-option.selected {
            border-color: var(--primary);
            background: #e6f7ff;
        }
    ...
    <div class="container-fluid">
        @if(!$is_individual)
            ...
            <div id="announcementTypeSelection" class="announcement-type-selection">
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="announcement-type-option" data-type="clasificados" onclick="selectAnnouncementType(this)">
                            <div class="announcement-type-icon">
                                <i class="fal fa-list"></i>
                            </div>
                            <div class="announcement-type-info">
                                <div class="announcement-type-title">@lang('Clasificados')</div>
                                <div class="announcement-type-description">@lang('For buying and selling items')</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="announcement-type-option" data-type="directorio" onclick="selectAnnouncementType(this)">
                            <div class="announcement-type-icon">
                                <i class="fal fa-building"></i>
                            </div>
                            <div class="announcement-type-info">
                                <div class="announcement-type-title">@lang('Directorio')</div>
                                <div class="announcement-type-description">@lang('For businesses and services')</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="announcement-type-option" data-type="servicio" onclick="selectAnnouncementType(this)">
                            <div class="announcement-type-icon">
                                <i class="fal fa-wrench"></i>
                            </div>
                            <div class="announcement-type-info">
                                <div class="announcement-type-title">@lang('Servicio')</div>
                                <div class="announcement-type-description">@lang('For professional services')</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="wizardContainer" style="display: none;">
            ...
            <form action="{{ route('user.storeListing', $id) }}" method="post" enctype="multipart/form-data">
                ...
                <div id="tab1" class="add-listing-form content active">
                    <div id="validationAlert" class="alert alert-danger alert-dismissible fade" role="alert"
                        style="display:none;">
                        <strong>@lang('Por favor completa los siguientes campos:')</strong>
                        <ul id="validationAlertList" class="mb-0 mt-1"></ul>
                        <button type="button" class="btn-close"
                            onclick="this.parentElement.style.display='none';this.parentElement.classList.remove('show');"></button>
                    </div>
                                ...
                                <div class="basic-form">
                                    <div class="row g-3">
                                        <div class="input-box col-md-12">
                                            <input
                                                class="form-control change_name_input @error('title') is-invalid @enderror"
                                        ...
                                        <div class="input-box col-md-4 boat-fields" style="display: none;">
                                        ...
                                        <div class="input-box col-md-4 boat-fields" style="display: none;">
                                            <select class="form-control @error('combustible') is-invalid @enderror" name="combustible">
                                                ...
                                                <option value="gasolina" {{ old('combustible') == 'gasolina' ? 'selected' : '' }}>@lang('Gasolina')</option>
                                                <option value="diesel" {{ old('combustible') == 'diesel' ? 'selected' : '' }}>@lang('Diésel')</option>
                                                <option value="electrico" {{ old('combustible') == 'electrico' ? 'selected' : '' }}>@lang('Eléctrico')</option>
                                                <option value="hibrido" {{ old('combustible') == 'hibrido' ? 'selected' : '' }}>@lang('Híbrido')</option>
                                            </select>
                                            <div class="invalid-feedback">
                                            ...
                                            <div class="d-flex flex-grow-1">
                                                <div class="input-box w-100 my-1 me-1">
                                                    <input type="time" name="start_time[]" value="{{ old("start_time.$i") }}"
                                                        class="form-control" placeholder="@lang('Start Hour')" />
                                                </div>

                                                <div class="input-box w-100 my-1 me-1">
                                                    <input type="time" name="end_time[]" value="{{ old("end_time.$i") }}"
                                                        class="form-control" placeholder="@lang('End Hour')" />
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                ...
                @if($single_package_infos->is_video == 1)
                    <div id="tab2" class="add-listing-form content">
                        <div class="main row gy-4">
                            <div class="col-xl-6">
                                <h3 class="mb-3">
                                    @lang('Video') <span class="optional">(@lang('Optional'))</span>
                                </h3>
                                <div class="form">
                                    <div class="row g-3">
                                        <div class="input-box col-md-12">
                                            <input class="form-control @error('youtube_video_id') is-invalid @enderror"
                                                type="text" placeholder="@lang('https://www.youtube.com/watch?v=...')"
                                                value="{{ old('youtube_video_id') }}" name="youtube_video_id"
                                                id="youtube_video_id" />
                                            @error('youtube_video_id')
                                                <span class="text-danger d-block" id="yt-error-message">{{ $message }}</span>
                                            @enderror
                                        </div>

                                        <div class="col-12">
                                            <div class="youtube nk-plain-video">
                                                <iframe src="" id="youtube_iframe" title="YouTube video"
                                        ...
                                        <div class="input-box col-md-12">
                                            <select
                                                ...
                                                @foreach ($all_amenities as $item)
                                                    <option value="{{ $item->id }}" {{ (collect(old('amenity_id'))->contains($item->id)) ? 'selected' : '' }}>
                                                        {{ $item->details->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="main row gy-4">
                                            ...
                                            <div class="row g-3">
                                                <div class="input-box col-md-6">
                                                    <input class="form-control @error('fb_app_id') is-invalid @enderror" type="text"
                                                        name="fb_app_id" value="{{ old('fb_app_id') }}"
                                                ...
                                                <div class="input-box col-md-6">
                                                    <input class="form-control @error('fb_page_id') is-invalid @enderror"
                                                        type="text" name="fb_page_id" value="{{ old('fb_page_id') }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="card card-primary shadow">
                                        ...
                                        <div class="card-body">
                                            Step One: Visit The Facebook Developers Page. To start with, navigate your browser to
                                            the
                                            Facebook Developers page. ...
                                            Step Three: Add Products In Your App. Now you have to add “Facebook Login” product in
                                            your
                                            app. ...
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="input-box col-md-6">
                                                    <input class="form-control @error('replies_text') is-invalid @enderror"
                                                        type="text" name="replies_text" value="{{ old('replies_text') }}"
    ...
    @push('script')
        <script>
            $(document).ready(function () {
                $('#youtube_video_id').on('input', function () {
                    var url = $(this).val();
                    var videoId = extractYoutubeVideoId(url);
                    if (videoId) {
                        $('#youtube_iframe').attr('src', 'https://www.youtube.com/embed/' + videoId);
                    }
                });
        ...
        <script>
            ...
            @endif
                ...
                function selectAnnouncementType(element) {
                    ...
                    $('.announcement-type-option').removeClass('selected');
            ...
            function loadCategoriesByType(type) {
                // Show loading state
                $('#category_id').prop('disabled', true).html('<option value="">@lang("Loading...")</option>').trigger('change');

                // AJAX call to get categories based on announcement type
                $.ajax({
                    url: "{{ route('get.categories.by.type') }}",
                    type: "POST",
                    data: {
                        "_token": "{{ csrf_token() }}",
                        "type": type
                    ...
                    success: function (result) {
                        ...
                        $('#category_id').html('<option value="">@lang("Select Categories")</option>');
                        ...
                        $('#category_id').select2({
                            width: '100%',
                            placeholder: '@lang("Select Categories")',
                            maximumSelectionLength: {{$single_package_infos->no_of_categories_per_listing}}
                                                                        });

                        // Trigger change to initialize dependent fields
                    ...
                    error: function () {
                        ...
                        // Show error message
                        $('#category_id').html('<option value="">@lang("Error loading categories")</option>').trigger('change');
                    }
                });
            }
