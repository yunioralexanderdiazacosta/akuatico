...
@section('content')
    ...
    <style>
        ...
        .dark-mode .input-group-text {
            color: #fffff6;
            background-color: {{ basicControl()->base_color ?? '#8fb568'}};
            border: 1px solid{{ basicControl()->base_color ?? '#8fb568'}};
        }
    </style>
                                        ...
                                        <form role="form" id="payment-form" method="{{$data->method}}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group input-box align-items-center">
                                                        ...
                                                        <span class="input-group-text ms-1 py-2"><i
                                                                class="fal fa-font"></i></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group input-box align-items-center">
                                                        <input type="tel" class="form-control white" name="cardNumber"
                                                               ...
                                                               required>
                                                        <div class="input-group-append">
                                                        <span class="input-group-text ms-1 py-2">
                                            ...
                                            <div class="btn-wrapper">
                                                <input class=" cmn-btn btn-custom py-2 w-100 border-0" type="submit" value="PAY NOW">
                                            </div>
                                        </form>
                                    </div>
                                </div>
