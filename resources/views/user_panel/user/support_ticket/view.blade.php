        ...
        <div class="main row">
            <div class="col-12">
                <div
                    ...
                    <h3 class="mb-0 d-flex align-items-normal">
                        {{trans('Ticket #'). $ticket->ticket }} [{{ $ticket->subject }}]
                        <span class="ticket-span-view d-flex align-items-center ms-1">
                            @if($ticket->status == 0)
                                                           ...
                                                           <div class="input-box col-md-12">
                                                               <div
                                                                   ...
                                                                   <button type="submit"
                                                                           ...
                                                                           title="{{trans('Reply')}}" name="reply_ticket"
                                                                                        ...
                                                                                        <div class="bug_fixing_inbox_start__msg__rec_msg__text">
                                                                                            <div class="bug_fixing_inbox_start__msg__rec_msg__text__one message">
                                                                                                <div class="image__title d-flex align-items-center">
                                                                                                    <img src="{{getFile(optional($ticket->user)->image_driver, optional($ticket->user)->image)}}" class="ticket-user-img" class="me-2" alt="image">
                                                                                                    <h6 class="m-0 text-dark">{{optional($ticket->user)->username}}</h6>
                                                                                                </div>
                                                                ...
                                                                @else
                                                                    <div
                                                                        ...
                                                                        <div class="bug_fixing_inbox_start__msg__outgoing_msg__new border_down customer-product-message">
                                                                            <div class="image__title d-flex  align-items-center">
                                                                                <img src="{{getFile(optional($item->admin)->image_driver, optional($item->admin)->image)}}" class="me-2 ticket-user-img" >
                                                                                <h6 class="m-0 text-dark">{{optional($item->admin)->name}}</h6>
                                                                            </div>
                ...
                <div class="modal-content">
                    ...
                    <form method="post" action="{{ route('user.ticket.reply', $ticket->id) }}">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="rounded-3 text-capitalize btn-custom customButton addCreateListingRoute" name="reply_ticket"
