                ...
                @foreach($gateways as $key => $gateway)
                    <div class="col-xl-2 col-lg-3 col-md-4  col-sm-6 col-6 mb-30">
                        <div class="card card-type-1 text-center">
                            <div class="card-icon">
                                <img class="w-100" src="{{ getFile($gateway->driver, $gateway->image)}}"
                ...
                <div class="modal-content form-block">
                    ...
                    <div class="modal-body ">
                        ...
                        <div class="payment-info text-center">
                            <img class="w-100" id="loading" src="{{asset('assets/admin/images/loading.gif')}}"
                                 alt="image"
                                 class="w-15"/>
                        </div>
                    </div>
...
@push('script')
    <script>
        ...
        $('.addFund').on('click', function () {
            ...
            baseSymbol = "{{ basicControl()->currency_symbol }}";
