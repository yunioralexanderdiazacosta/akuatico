...
@section('content')
    <!-- LOGIN-SIGNUP -->
    <section id="login-signup" class="section__padding">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="d-flex align-items-center justify-content-start">
                        <div class="wrapper">
                            <div class="login-info-wrapper">
                                <img class="w-100" src="{{asset(template(true).'images/verification.jpg')}}" alt="image" class="w-100">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <form method="POST" action="" class="form-content w-100">
                            ...
                            <div class="login">
                                <div class="form-group">
                                    <input class="form-control" type="text" name="username" value="{{old('username')}}" placeholder="@lang('Code')">
                                    @error('username')
