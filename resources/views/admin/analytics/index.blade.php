...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="modal fade" id="deleteMultipleModal" tabindex="-1" role="dialog"
             aria-labelledby="deleteMultipleModalLabel" data-bs-backdrop="static"
             aria-hidden="true">
        ...
        <div id="analyticDetailsModal" class="modal fade" tabindex="-1" role="dialog"
             aria-labelledby="analyticDetailsModalLabel" aria-hidden="true">
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ajax: {
                    url: "{{ route('admin.listing.analytics.search') }}",
                },
                columns: [
            ...
            $(document).on('click', '#filter_button', function () {
                ...
                datatable.ajax.url("{{ route('admin.listing.analytics.search') }}" + "&filterDate=" + filterDate).load();
            });
