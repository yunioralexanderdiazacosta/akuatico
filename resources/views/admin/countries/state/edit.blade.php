                ...
                <div class="col-sm">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang("Edit State")</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="{{ route('admin.country.all.state',$state->country_id) }}" class="btn btn-primary">@lang("Back")</a>
                        </div>
