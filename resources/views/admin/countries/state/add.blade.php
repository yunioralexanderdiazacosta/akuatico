                ...
                <div class="col-sm">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang("State Add")</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="{{ route('admin.country.all.state',$country->id) }}" class="btn btn-info"><i style="padding-right: 5px" class="bi bi-arrow-left"></i>@lang("Back")</a>
                        </div>
                        <div class="card-body mt-2">
                            <form action="{{ route('admin.country.state.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="d-flex justify-content-end mt-4">
                                    <button type="submit"
                                            class="btn btn-primary submit_btn">@lang("Add State")</button>
                                </div>
                            </form>
                        </div>
                    </div>
