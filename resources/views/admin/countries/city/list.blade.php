                ...
                <div class="card">
                    <div class="card-header card-header-content-md-between">
                        ...
                        <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                            ...
                            <div class="dropdown">
                                <a style="padding: 8px" href="{{ route('admin.country.all.state',$country) }}" class="btn btn-primary"><i style="padding-right: 5px;font-size: 12px" class="bi bi-arrow-left"></i>@lang("Back")</a>
                            </div>
                        </div>
                    </div>
