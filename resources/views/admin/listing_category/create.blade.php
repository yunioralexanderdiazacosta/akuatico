...
@section('page_title',__('Listing Category Create'))
@section('content')
        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <h1 class="page-header-title">@lang('Add Category')</h1>
                </div>
            </div>
        </div>
                ...
                <div class="tab-content mt-2" id="myTabContent">
                    @foreach($languages as $key => $language)
                        <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="lang-tab-{{ $key }}" role="tabpanel">
                            <form method="post" action="{{ route('admin.listing.category.store', $language->id) }}" class="mt-4" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
