...
@section('page_title',__('Listing Category'))
@section('content')
        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <h1 class="page-header-title">@lang('Category')</h1>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header card-header-content-md-between">
                ...
                <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                    ...
                    @if(adminAccessRoute(config('role.listing_category.access.delete')))
                    ...
                    @endif
                    @if(adminAccessRoute(config('role.listing_category.access.add')))
                        <a href="{{ route('admin.listing.category.create') }}" class="btn btn-sm btn-primary">@lang('Add Category')</a>
                    @endif
                    <div class="dropdown">
            ...
            <div class="modal-content">
                ...
                <form action="" method="post" class="deleteRoute">
                    ...
                    <div class="modal-body">
                        @lang('Do you want to delete `')<span class="deletedTitle fw-bold"></span>@lang('` category?')
                    </div>
    ...
    <script>
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route("admin.listing.category.search") }}",
                },
                columns: [
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route('admin.listing.category.search') }}"  + "?filterStatus=" + filterStatus +
            ...
            $(document).on('click', '.delete-multiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.listing.category.delete.multiple') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
