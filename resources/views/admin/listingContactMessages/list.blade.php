...
@section('content')
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item"><a class="breadcrumb-link"
                                                           href="javascript:void(0);">@lang('Listing Message')</a></li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang('Messages')</h1>
                </div>
            </div>
        </div>
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <div class="input-group input-group-merge input-group-flush">
                        ...
                        <input id="datatableSearch" type="search" class="form-control" placeholder="Search Message"
                               aria-label="Search Message" autocomplete="off">
                    </div>
                </div>

                <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                    @if(adminAccessRoute(config('role.contact_message.access.delete')))
                        ...
                        <div
                            ...
                            <div class="card">
                                <div class="card-header card-header-content-between">
                                    <h5 class="card-header-title">@lang('Filter Messages')</h5>
    ...
    <div class="modal fade" id="userDeleteMultipleModal" tabindex="-1" role="dialog"
         aria-labelledby="userDeleteMultipleModalLabel" data-bs-backdrop="static"
         aria-hidden="true">
    ...
    <div class="modal fade" id="messageViewModalModal" tabindex="-1" role="dialog" aria-hidden="true"
         data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="text-center mb-5">
                        <h3 class="mb-1">@lang('Message Information')</h3>
                    </div>

                    <div class="row mb-6">
                        <div class="col-md-4 mb-3 mb-md-0">
                            <small class="text-cap text-secondary mb-0">@lang('From:')</small>
                            <span class="text-dark messageFrom"></span>
                        </div>

                        <div class="col-md-4 mb-3 mb-md-0">
                            <small class="text-cap text-secondary mb-0">@lang('To:')</small>
                            <span class="text-dark messageTo"></span>
                        </div>

                        <div class="col-md-4">
                            <small class="text-cap text-secondary mb-0">@lang('Date:')</small>
                            <span class="text-dark contactDateTime"></span>
                        </div>
                    </div>

                    <small class="text-cap mb-2">@lang('Message')</small>
                    <ul class="list-group mb-4">
                        <li class="list-group-item contactMessage"><span class="contactDateTime"></span></li>
                    </ul>
    ...
    <script>
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route("admin.contact.message.search") }}",
            ...
            $(document).on('click', '#filter_button', function () {
                ...
                datatable.ajax.url("{{ route('admin.contact.message.search') }}" + "?filterName=" + filterName + "&filterDate=" + filterDate).load();
            });
            ...
            $(document).on('click', '.delete-multiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.contact.message.delete.multiple') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
            ...
            $(document).on('click', '.showMessage', function () {
                let messageFrom = $(this).data('from');
                let messageTo = $(this).data('to');
                let contactMessage = $(this).data('message');
                let contactDateTime = $(this).data('time');

                $('.messageFrom').text(messageFrom);
                $('.messageTo').text(messageTo);
                $('.contactMessage').text(contactMessage);
                $('.contactDateTime').text(contactDateTime);
            });
