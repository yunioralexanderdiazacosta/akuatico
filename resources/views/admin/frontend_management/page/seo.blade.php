...
@section('page_title', __(optional($pageSEO->details)->name ?? ucfirst($pageSEO->name) . ' Page SEO'))
@section('content')
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang(optional($pageSEO->details)->name ??  ucfirst($pageSEO->name) . ' Page SEO')</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang(optional($pageSEO->details)->name ?? ucfirst($pageSEO->name) . ' Page SEO')</h1>
                </div>
            </div>
        </div>
                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="card-title h4">@lang(optional($pageSEO->details)->name ?? ucfirst($pageSEO->name) . ' Page SEO')</h2>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('meta_title', $pageSEO->meta_title) }}" autocomplete="off">
                                        @error('meta_title')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <textarea id="metaDescription" class="form-control" name="meta_description"
                                                  ...
                                                  rows="4">{{ old("meta_description", $pageSEO->meta_description) }}</textarea>
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <textarea id="ogDescription" class="form-control" name="og_description"
                                                  ...
                                                  rows="4">{{ old("og_description", $pageSEO->og_description) }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="tom-select-custom tom-select-custom-with-tags">
                                        <select class="js-select form-select meta-robot-select2" autocomplete="off"
                                            ...
                                            <option
                                                value="index" {{ in_array("index", $pageSEO->getMetaRobots()) ? 'selected' : '' }}>
                                                Index
                                            </option>
                                            <option
                                                value="noindex" {{ in_array("noindex", $pageSEO->getMetaRobots()) ? 'selected' : '' }}>
                                                No index
                                            </option>
                                            <option
                                                value="follow" {{ in_array("follow", $pageSEO->getMetaRobots()) ? 'selected' : '' }}>
                                                Follow
                                            </option>
                                            <option
                                                value="nofollow" {{ in_array("nofollow", $pageSEO->getMetaRobots()) ? 'selected' : '' }}>
                                                No follow
                                            </option>
                                            <option
                                                value="noarchive" {{ in_array("noarchive", $pageSEO->getMetaRobots()) ? 'selected' : '' }}>
                                                Noarchive
                                            </option>
                                            <option
                                                value="nosnippet" {{ in_array("nosnippet", $pageSEO->getMetaRobots()) ? 'selected' : '' }}>
                                                Nosnippet
                                            </option>
                                        </select>
                                    </div>
