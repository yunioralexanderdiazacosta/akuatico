...
@section('page_title',__('Listing Dynamic Form Data'))
@section('content')
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">@lang('Listing Dynamic Form Data')</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Form Data for - ' .$listing->title)</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header card-header-content-md-between">
                    ...
                    <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                        @if(adminAccessRoute(config('role.listing_form.access.delete')))
                            ...
                            <div
                                ...
                                <div class="card">
                                    <div class="card-header card-header-content-between">
                                        <h5 class="card-header-title">@lang('Filter Form Data')</h5>
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>@lang("Do you want to delete this Form Data")</p>
                    </div>
        ...
        <div class="modal fade" id="detailsModal" tabindex="-1" role="dialog" aria-labelledby="detailsModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="detailsModalLabel">@lang("Details Information")</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
            ...
            <script>
                $(document).on('ready', function () {
                    ...
                    HSCore.components.HSDatatables.init($('#datatable'), {
                        ...
                        ajax: {
                            url: "{{ route('admin.listing.form.data.search', '') }}" + '/' + listingId,
                    ...
                    $(document).on('click', '#filter_button', function () {
                        ...
                        datatable.ajax.url("{{ route('admin.listing.form.data.search','') }}" + '/' + listingId + "?filterDate=" + filterDate).load();
                    });
                    ...
                    $(document).on('click', '.delete-multiple', function (e) {
                        ...
                        $.ajax({
                            ...
                            url: "{{ route('admin.listing.form.data.delete.multiple') }}",
                            data: {strIds: strIds},
                            dataType: 'json',
                            type: "post",
                ...
                function viewDetails(id) {
                    $.ajax({
                        url: "{{ route('admin.listing.form.data.details') }}",
                        method: 'POST',
                        data: {
                            id: id,
                            _token: '{{ csrf_token() }}',
                        ...
                        success: function (response) {
                            var inputForm = response.input_form;
                            var modalBody = $('#detailsModal .modal-body');
                            modalBody.empty();

                            $.each(inputForm, function(key, item) {
                                var div = $('<div>', { class: 'd-flex align-items-center p-3 border border-light mb-1' });

                                if (item.type == 'file' && item.field_value) {
                                    div.html(`
                                        <strong class="pe-3">${item.field_name}:</strong>
                                        <a href="${item.field_value}" download>Download File</a>
                                    `);
                                } else {
                                    div.html(`
                                        <strong class="pe-3">${item.field_name}:</strong>
