...
@section('page_title',__('Create Package'))
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="shadow p-3 mb-4 alert-soft-blue" role="alert">
                    <div class="alert-box d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h3 class="text-info mb-1">@lang("Attention!")</h3>
                            <div class="d-flex align-items-center">
                                <p class="mb-0 text-body"> @lang("Auto-subscription is available on a monthly or yearly basis. To enable auto-subscription, you must select either a 1 Month or 1 Year package expiry; otherwise, auto-subscription will not be activated.")</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-content mt-2" id="myTabContent">
                    @foreach($languages as $key => $language)
                        <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="lang-tab-{{ $key }}"
                             role="tabpanel">
                            <form method="post" action="{{ route('admin.package.store', $language->id) }}" class="mt-4" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12 mb-3 package_title">
                                        ...
                                        <input type="text" name="title[{{ $language->id }}]"
                                               ...
                                               value="{{ old('title'.'.'.$language->id) }}" placeholder="@lang('package title')">
                                        ...
                                        <div class="col-lg-4 col-md-4 form-group col-sm-12 col-12 package_price_div">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="checkbox" name="is_free" value="-1"
                                                       {{ old('is_free') == -1 ? 'checked' : '' }} id="free_package"
                                                                ...
                                                                <label class="row form-check form-switch mb-3" for="is_multiple_time_purchase">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input class="form-check-input @error('is_multiple_time_purchase') is-invalid @enderror"
                                                                               type="checkbox" name="is_multiple_time_purchase" id="is_multiple_time_purchase" value="1" {{ old('is_multiple_time_purchase') == "1" ? 'checked' : '' }}>
                                                                    </span>
                                        ...
                                        <div class="form-group col-lg-4 col-md-4 col-sm-12 col-12 mb-3 package_expiry">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="expiry_time"
                                                       ...
                                                       value="{{ old('expiry_time') }}" placeholder="@lang('time')">
                                                <div class="input-group-append">
                                                    ...
                                                    <input type="checkbox" name="expiry_time_unlimited" value="-1"
                                                           {{ old('expiry_time_unlimited') == -1 ? 'checked' : '' }}
                                        ...
                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-12">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" min="1" name="no_of_listing" placeholder="Enter listing number"
                                                       class="no_of_listing form-control @error('no_of_listing') is-invalid @enderror"
                                                       aria-describedby="basic-addon2" value="{{ old('no_of_listing') }}">

                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2"> <span
                                                        class="me-2">@lang('Unlimited')</span>
                                                <input type="checkbox" name="no_of_listing_unlimited" value="-1"
                                                       {{ old('no_of_listing_unlimited') == -1 ? 'checked' : '' }} id="listing_unlimited"
                                        ...
                                        <div class="form-group col-lg-3 col-md-3 col-12">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" name="no_of_categories_per_listing"
                                                       value="{{ old('no_of_categories_per_listing') }}" min="1" placeholder="Enter category number per listing"
                                                                ...
                                                                <label class="row form-check form-switch mb-3" for="is_image">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input class="form-check-input @error('is_image') is-invalid @enderror"
                                                                               type="checkbox" name="is_image" id="is_image" value="1" {{ old('is_image') == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                                    @error('is_image')
                                                                    <span class="invalid-feedback d-block">{{ $message }}</span>
                                                                    @enderror
                                        ...
                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-12">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" name="no_of_img_per_listing" min="1" placeholder="Enter image number per listing"
                                                       value="{{ old('no_of_img_per_listing') }}"
                                                ...
                                                <span class="input-group-text" id="basic-addon2"> <span
                                                    ...
                                                    <input type="checkbox" name="no_of_img_per_listing_unlimited"
                                                           value="-1"
                                                           {{ old('no_of_img_per_listing_unlimited') == -1 && old('is_image') == 1  ? 'checked' : '' }} id="listing_img_unlimited"
                                                                ...
                                                                <label class="row form-check form-switch mb-3" for="is_video">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input class="form-check-input @error('is_video') is-invalid @enderror"
                                                                               type="checkbox" name="is_video" id="is_video" value="1" {{ old('is_video') == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                                    @error('is_video')
                                                                    <span class="invalid-feedback d-block">{{ $message }}</span>
                                                                    @enderror
                                                                ...
                                                                <label class="row form-check form-switch mb-3" for="is_amenities">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input class="form-check-input @error('is_amenities') is-invalid @enderror"
                                                                               type="checkbox" name="is_amenities" id="is_amenities" value="1" {{ old('is_amenities') == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                                    @error('is_amenities')
                                                                    <span class="invalid-feedback d-block">{{ $message }}</span>
                                                                    @enderror
                                        ...
                                        <div class="form-group col-lg-3 col-md-3 col-12">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" name="no_of_amenities_per_listing"
                                                       value="{{ old('no_of_amenities_per_listing') }}" min="1" placeholder="Enter amenity number per listing"
                                                ...
                                                <span class="input-group-text" id="basic-addon2"> <span
                                                    ...
                                                    <input type="checkbox" name="no_of_amenities_per_listing_unlimited"
                                                           value="-1"
                                                           {{ old('no_of_amenities_per_listing_unlimited') == -1 && old('is_amenities') == 1  ? 'checked' : '' }} id="amenities_unlimited"
                                                                ...
                                                                <label class="row form-check form-switch mb-3" for="is_product">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input class="form-check-input @error('is_product') is-invalid @enderror"
                                                                               type="checkbox" name="is_product" id="is_product" value="1" {{ old('is_product') == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                                    @error('is_product')
                                                                    <span class="invalid-feedback d-block">{{ $message }}</span>
                                                                    @enderror
                                        ...
                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-12">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" name="no_of_product" min="1" placeholder="Enter product number"
                                                       ...
                                                       aria-describedby="basic-addon2" value="{{ old('no_of_product') }}">

                                                <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2"> <span
                                                        class="me-2">@lang('Unlimited')</span>
                                                    <input type="checkbox" name="no_of_product_unlimited" value="-1"
                                                           {{ old('no_of_product_unlimited') == -1 && old('is_product') == 1  ? 'checked' : '' }} id="product_unlimited"
                                        ...
                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-12">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" name="no_of_img_per_product"
                                                       value="{{ old('no_of_img_per_product') }}" min="1" placeholder="Enter image number per product"
                                                ...
                                                <span class="input-group-text" id="basic-addon2"> <span
                                                    ...
                                                    <input type="checkbox" name="no_of_img_per_product_unlimited"
                                                           value="-1"
                                                           {{ old('no_of_img_per_product_unlimited') == -1 && old('is_product') == 1  ? 'checked' : '' }} id="product_img_unlimited"
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <div class="row align-items-center">
                                                                <div class="col">
                                                                <span class="d-block fs-6 text-body">
                                                                    @lang('Allow to create dynamic form to collect user data')
                                                                </span>
                                                                </div>
                                                                <div class="col-auto">
                                                                    ...
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input class="form-check-input @error('is_create_from') is-invalid @enderror"
                                                                               type="checkbox" name="is_create_from" id="is_create_from" value="1" {{ old('is_create_from') == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                                ...
                                                                <label class="row form-check form-switch mb-3" for="is_business_hour">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input class="form-check-input @error('is_business_hour') is-invalid @enderror"
                                                                               type="checkbox" name="is_business_hour" id="is_business_hour" value="1" {{ old('is_business_hour') == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                                ...
                                                                <label class="row form-check form-switch mb-3" for="seo">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input class="form-check-input @error('seo') is-invalid @enderror"
                                                                               type="checkbox" name="seo" id="seo" value="1" {{ old('seo') == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                                    @error('seo')
                                                                    <span class="invalid-feedback d-block">{{ $message }}</span>
                                                                    @enderror
                                                                ...
                                                                <label class="row form-check form-switch mb-3" for="is_messenger">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input class="form-check-input @error('is_messenger') is-invalid @enderror"
                                                                               type="checkbox" name="is_messenger" id="is_messenger" value="1" {{ old('is_messenger') == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                                    @error('is_messenger')
                                                                    <span class="invalid-feedback d-block">{{ $message }}</span>
                                                                    @enderror
                                                                ...
                                                                <label class="row form-check form-switch mb-3" for="is_whatsapp">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input class="form-check-input @error('is_whatsapp') is-invalid @enderror"
                                                                               type="checkbox" name="is_whatsapp" id="is_whatsapp" value="1" {{ old('is_whatsapp') == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                                    @error('is_whatsapp')
                                                                    <span class="invalid-feedback d-block">{{ $message }}</span>
                                                                    @enderror
                                                                ...
                                                                <label class="row form-check form-switch mb-3" for="is_renew">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input class="form-check-input @error('is_renew') is-invalid @enderror"
                                                                               type="checkbox" name="is_renew" id="is_renew" value="1" {{ old('is_renew') == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                                    @error('is_renew')
                                                                    <span class="invalid-feedback d-block">{{ $message }}</span>
                                                                    @enderror
                                                                ...
                                                                <div class="col-auto">
                                                                    ...
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input class="form-check-input @error('status') is-invalid @enderror"
                                                                               type="checkbox" name="status" id="status" value="1" {{ old('status') == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                                        @error('status')
                                                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                                                        @enderror
...
@push('script')
    <script>
        $(document).on('ready', function () {
            ...
            $('.package_price, .expiry_time, .expiry_time_type, .no_of_listing').removeAttr('disabled');
