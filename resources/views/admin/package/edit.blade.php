                ...
                <div class="tab-content mt-2" id="myTabContent">
                    @foreach($languages as $key => $language)
                        <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="lang-tab-{{ $key }}"
                            role="tabpanel">
                            <form method="post" action="{{ route('admin.package.update', [$id, $language->id]) }}" class="mt-4"
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12 mb-3 package_title">
                                        ...
                                        <input type="text" name="title[{{ $language->id }}]"
                                            ...
                                            value="{{ old('title' . '.' . $language->id, isset($packageDetails[$language->id]) ? $packageDetails[$language->id][0]->title : '') }}"
                                            placeholder="@lang('package title')">
                                        ...
                                        <div class="col-lg-4 col-md-4 form-group col-sm-12 col-12 package_price_div">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="price"
                                                    value="{{ old('price', isset($packageDetails[$language->id]) ? optional($packageDetails[$language->id][0]->package)->price : '') }}"
                                                ...
                                                <div class="input-group-append">
                                                    ...
                                                    <span class="input-group-text" id="basic-addon2"> <span
                                                        ...
                                                        <input type="checkbox" name="is_free" value="-1" {{ old('is_free') == -1 || isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->price == null ? 'checked' : '' }} id="free_package" class="free_package"></span>
                                                </div>
                                                <div class="invalid-feedback">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-auto">
                                                                <label class="row form-check form-switch mb-3"
                                                                    for="is_multiple_time_purchase">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        <input type='hidden' value='0'
                                                                            name='is_multiple_time_purchase'>
                                                                        <input
                                                                            class="form-check-input @error('is_multiple_time_purchase') is-invalid @enderror"
                                                                            type="checkbox" name="is_multiple_time_purchase"
                                                                            id="is_multiple_time_purchase" value="1" {{ old('is_multiple_time_purchase', isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->is_multiple_time_purchase) == "1" ? 'checked' : '' }}>
                                                                    </span>
                                        ...
                                        <div class="form-group col-lg-4 col-md-4 col-sm-12 col-12 mb-3 package_expiry">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="expiry_time"
                                                    class="form-control expiry_time @error('expiry_time') is-invalid @enderror"
                                                ...
                                                <div class="input-group-append">
                                                    <select class="form-control expiry_time_type" id="expiry_time_type"
                                                        name="expiry_time_type" {{ old('expiry_time_type', isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->expiry_time) == null ? 'disabled' : '' }}>
                                                        <option value="Days" {{ isset($packageDetails[$language->id]) ?? $packageDetails[$language->id][0]->package->expiry_time_type == 'Days' || isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->expiry_time_type == 'Day' ? 'selected' : '' }}>@lang('Day(s)')</option>
                                                    ...
                                                    <span class="input-group-text" id="basic-addon2"> <span
                                                            class="me-2">@lang('Unlimited')</span> <input type="checkbox"
                                                            name="expiry_time_unlimited" value="-1" id="expiry_time_unlimited"
                                                            class="expiry_time_unlimited" {{ old('expiry_time_unlimited') == -1 || isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->expiry_time == null ? 'checked' : '' }}></span>
                                                </div>
                                ...
                                @if ($loop->index == 0)
                                    <div class="row mb-3 g-3">
                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-12">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" min="1" name="no_of_listing" placeholder="Enter listing number"
                                                    class="no_of_listing form-control @error('no_of_listing') is-invali @enderror"
                                                    aria-describedby="basic-addon2"
                                                    value="{{ old('no_of_listing', optional($packageDetails[$language->id][0]->package ?? null)->no_of_listing) }}"
                                                    {{ old('no_of_listing', optional($packageDetails[$language->id][0]->package ?? null)->no_of_listing) == null ? 'disabled' : '' }}>

                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2"> <span
                                                            class="me-2">@lang('Unlimited')</span> <input type="checkbox"
                                                            name="no_of_listing_unlimited" value="-1" id="listing_unlimited"
                                                            class="listing_unlimited" {{ old('no_of_listing_unlimited') == -1 || (!old('no_of_listing_unlimited') && optional($packageDetails[$language->id][0]->package ?? null)->no_of_listing == null) ? 'checked' : '' }}></span>
                                                </div>
                                        ...
                                        <div class="form-group col-lg-3 col-md-3 col-12">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" name="no_of_categories_per_listing"
                                                    placeholder="Enter category number per listing"
                                                    value="{{ old('no_of_categories_per_listing', isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->no_of_categories_per_listing) }}"
                                                    min="1"
                                                            ...
                                                            <div class="col-auto">
                                                                <label class="row form-check form-switch mb-3" for="is_image">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input
                                                                            class="form-check-input @error('is_image') is-invalid @enderror"
                                                                            type="checkbox" name="is_image" id="is_image" value="1"
                                                                            {{ old('is_image') || isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->is_image == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                                    @error('is_image')
                                                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                                                    @enderror
                                        ...
                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-12">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" name="no_of_img_per_listing" min="1"
                                                    placeholder="Enter image number per listing"
                                                    value="{{ old('no_of_img_per_listing', optional($packageDetails[$language->id][0]->package ?? null)->no_of_img_per_listing) }}"
                                                    class="form-control no_of_img_per_listing @error('no_of_img_per_listing') is-invalid @enderror"
                                                    aria-describedby="basic-addon2" {{ old('is_image', optional($packageDetails[$language->id][0]->package ?? null)->is_image) == 0 || old('listing_img_unlimited') == -1 || optional($packageDetails[$language->id][0]->package ?? null)->no_of_img_per_listing == null ? 'disabled' : '' }}>

                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2"> <span
                                                            class="me-2">@lang('Unlimited')</span> <input type="checkbox"
                                                            name="no_of_img_per_listing_unlimited" value="-1"
                                                            id="listing_img_unlimited" class="listing_img_unlimited" {{ old('is_image', optional($packageDetails[$language->id][0]->package ?? null)->is_image) == 1 && (old('listing_img_unlimited') == -1 || optional($packageDetails[$language->id][0]->package ?? null)->no_of_img_per_listing == null) ? 'checked' : ''  }}></span>
                                                </div>
                                                <div class="invalid-feedback">
                                                            ...
                                                            <div class="col-auto">
                                                                <label class="row form-check form-switch mb-3" for="is_video">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input
                                                                            class="form-check-input @error('is_video') is-invalid @enderror"
                                                            ...
                                                            <div class="col-auto">
                                                                <label class="row form-check form-switch mb-3" for="is_amenities">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input
                                                                            class="form-check-input @error('is_amenities') is-invalid @enderror"
                                                                            type="checkbox" name="is_amenities" id="is_amenities"
                                                                            value="1" {{ old('is_amenities') || isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->is_amenities == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                                    @error('is_amenities')
                                                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                                                    @enderror
                                        ...
                                        <div class="form-group col-lg-3 col-md-3 col-12">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" name="no_of_amenities_per_listing"
                                                    placeholder="Enter amenity number per listing"
                                                    ...
                                                    min="1"
                                                    class="form-control no_of_amenities_per_listing @error('no_of_amenities_per_listing') is-invalid @enderror"
                                                    aria-describedby="basic-addon2" {{ old('is_amenities', isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->is_amenities) == 0 || old('amenities_unlimited') == -1 || isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->no_of_amenities_per_listing == null ? 'disabled' : '' }}>

                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2"> <span
                                                            class="me-2">@lang('Unlimited')</span> <input type="checkbox"
                                                            name="no_of_amenities_per_listing_unlimited" value="-1"
                                                            id="amenities_unlimited" class="amenities_unlimited" {{ old('is_amenities', isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->is_amenities) == 1 && (old('amenities_unlimited') == -1 || isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->no_of_amenities_per_listing == null) ? 'checked' : '' }}></span>
                                                </div>
                                                <div class="invalid-feedback">
                                                            ...
                                                            <div class="col-auto">
                                                                <label class="row form-check form-switch mb-3" for="is_product">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input
                                                                            class="form-check-input @error('is_product') is-invalid @enderror"
                                                                            type="checkbox" name="is_product" id="is_product"
                                                                            value="1" {{ old('is_product') || isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->is_product == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                                    @error('is_product')
                                                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                                                    @enderror
                                        ...
                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-12">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" name="no_of_product" min="1" placeholder="Enter product number"
                                                    class="no_of_product form-control @error('no_of_product') is-invalid @enderror"
                                                    aria-describedby="basic-addon2"
                                                ...
                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2"> <span
                                                            class="me-2">@lang('Unlimited')</span>
                                                        <input type="checkbox" name="no_of_product_unlimited" value="-1"
                                                            id="product_unlimited" class="product_unlimited" {{ old('is_product', isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->is_product) == 1 && (old('product_unlimited') == -1 || isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->no_of_product == null) ? 'checked' : '' }}></span>
                                                </div>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-lg-3 col-md-3 col-sm-12 col-12">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" name="no_of_img_per_product"
                                                    placeholder="Enter image number per product"
                                                    value="{{ old('no_of_img_per_product', isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->no_of_img_per_product) }}"
                                                    min="1"
                                                    class="form-control no_of_img_per_product @error('no_of_img_per_product') is-invalid @enderror"
                                                    aria-describedby="basic-addon2" {{ old('is_product', isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->is_product) == 0 || old('product_img_unlimited') == -1 || isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->no_of_img_per_product == null ? 'disabled' : '' }}>

                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2"> <span
                                                            class="me-2">@lang('Unlimited')</span> <input type="checkbox"
                                                            name="no_of_img_per_product_unlimited" value="-1"
                                                            id="product_img_unlimited" class="product_img_unlimited" {{ old('is_product', isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->is_product) == 1 && (old('product_img_unlimited') == -1 || isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->no_of_img_per_product == null) ? 'checked' : '' }}></span>
                                                </div>
                                                <div class="invalid-feedback">
                                                                ...
                                                                <div class="col-auto">
                                                                    <label class="row form-check form-switch mb-3"
                                                                        ...
                                                                        <span class="col-4 col-sm-3 text-end">
                                                                            ...
                                                                            <input
                                                                                class="form-check-input @error('is_create_from') is-invalid @enderror"
                                                                                type="checkbox" name="is_create_from"
                                                                                id="is_create_from" value="1" {{ old('is_create_from') || isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->is_create_from == "1" ? 'checked' : '' }}>
                                                                        </span>
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-auto">
                                                                <label class="row form-check form-switch mb-3"
                                                                    for="is_business_hour">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        <input type='hidden' value='0' name='is_business_hour'>
                                                                        <input
                                                                            class="form-check-input @error('is_business_hour') is-invalid @enderror"
                                                                            type="checkbox" name="is_business_hour"
                                                                            id="is_business_hour" value="1" {{ old('is_business_hour') || isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->is_business_hour == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                            ...
                                                            <div class="col-auto">
                                                                <label class="row form-check form-switch mb-3" for="seo">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input
                                                                            class="form-check-input @error('seo') is-invalid @enderror"
                                                                            type="checkbox" name="seo" id="seo" value="1" {{ old('seo') || isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->seo == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                                    @error('seo')
                                                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                                                    @enderror
                                                            ...
                                                            <div class="col-auto">
                                                                <label class="row form-check form-switch mb-3" for="is_messenger">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input
                                                                            class="form-check-input @error('is_messenger') is-invalid @enderror"
                                                                            type="checkbox" name="is_messenger" id="is_messenger"
                                                                            value="1" {{ old('is_messenger') || isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->is_messenger == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                                    @error('is_messenger')
                                                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                                                    @enderror
                                                            ...
                                                            <div class="col-auto">
                                                                <label class="row form-check form-switch mb-3" for="is_whatsapp">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input
                                                                            class="form-check-input @error('is_whatsapp') is-invalid @enderror"
                                                                            type="checkbox" name="is_whatsapp" id="is_whatsapp"
                                                                            value="1" {{ old('is_whatsapp') || isset($packageDetails[$language->id]) ?? optional($packageDetails[$language->id][0]->package)->is_whatsapp == "1" ? 'checked' : '' }}>
                                                                    </span>
                                                                    @error('is_whatsapp')
                                                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                                                    @enderror
                                                            ...
                                                            <div class="col-auto">
                                                                <label class="row form-check form-switch mb-3" for="is_renew">
                                                                    <span class="col-4 col-sm-3 text-end">
                                                                        ...
                                                                        <input
                                                                            class="form-check-input @error('is_renew') is-invalid @enderror"
                                        ...
                                        @if($gateways)
                                            @foreach($gateways as $gateway)
                                                <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                                                    <label class="form-label" for="SubscriptionLabel">{{$gateway->name}}
                                                        @lang('Subscription Plan Id')</label>
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-4 col-6">
                                            ...
                                            <label class="form-check form-check-dashed" for="logoUploader" id="content_img">
                                                ...
                                                <input type="file" name="image"
                                                    class="js-file-attach form-check-input @error('image') is-invalid @enderror"
                                ...
                                @endif
                                <button type="submit"
                                    class="btn waves-effect waves-light btn-rounded btn-primary btn-block mt-3 w-100">@lang('Save')</button>
                            </form>
                        </div>
                    @endforeach
                </div>
