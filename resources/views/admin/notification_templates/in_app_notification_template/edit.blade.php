                                        ...
                                        <form method="post"
                                                    ...
                                                    <label class=" row form-check form-switch"
                                                           for="status[{{ $value->id }}]">
                                                                <span class="col-8 col-sm-9 ms-0">
                                                                  ...
                                                                  <span
                                                                      class="d-block fs-5">@lang("Enable status for in-app notification.")</span>
                                                                </span>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <textarea class="form-control summernote @error('in_app_notification_template.'.$value->id) is-invalid @enderror"
