...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
		...
		define('leafletFullScreen', ['assets/admin/js/global/js/leaflet', 'screenfull'], factory);
  } else if (typeof module === 'object' && module.exports) {
		// define a CommonJS module that requires 'leaflet' and 'screenfull'
		module.exports = factory(require('assets/admin/js/global/js/leaflet'), require('screenfull'));
  } else {
